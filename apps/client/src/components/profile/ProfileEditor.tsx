...
function MediaAffinitiesEditor({
  ...
  return (
    <Section
      ...
      hint="Formats you've engaged with and how comfortable you are with each"
    >
      <ul className="space-y-3">
        {FORMAT_ORDER.map((format) => {
          ...
          if (!a) {
            return (
              <li
                key={format}
                className="flex items-center justify-between gap-3 rounded-md border border-neutral-800 bg-neutral-900/40 p-3"
              >
            ...
            >
              <div className="flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  title="Remove this format from profile"
                >
                  Remove
                </button>
              </div>
